...
/*let student = ['ABCD', 'EFGH', 'IJKL', 'MNOP'];
...
/*const student = {id: 1, name: 'fatah', email: '18-38830-3@aiub.student.edu'}
...
import {User,Student} from './Student';
const u1 = new User(1,'fatah', '18-38830-3@aiub.student.edu');
const u2 = new Student(1,'fatah', '18-38830-3@aiub.student.edu');
console.log(u1.name);
